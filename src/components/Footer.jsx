...
const Footer = () => {
  return (
    <div className='bg-black w-full h-[100vh] mt-[90px] text-white font-poppins text-center flex flex-col justify-center lg:text-[30px] text-[22px] space-y-12 cursor-pointer'>
        <Link to="/"><h1>Home</h1></Link>
        <Link to="/Information"><h1>Information</h1></Link>
        <Link to="/Contacts"><h1>Contact</h1></Link>
        <h1 className='pt-10 lg:text-[20px] text-[17px] lg:px-0 px-8'>Connect with us on social media for the latest updates</h1>
