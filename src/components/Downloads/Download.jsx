...
import playstore from '/image/information/playstore.png'
import appstore from '/image/information/appstore.png'
        ...
        <div className='flex lg:flex-row flex-col justify-around items-center lg:px-[20px] px-[10px]'>
            <div>
                <div className='lg:w-[450px] space-y-2' data-aos="fade-right" data-aos-duration="800">
                    ...
                    <div className='flex lg:justify-left justify-center items-center lg:space-x-5 space-x-7 lg:scale-100 scale-75 pt-3 cursor-pointer'>
                        <img src={playstore} alt="" className='h-auto w-[180px] hover:scale-90 hover:opacity-80 transition-all'/>
                        <img src={appstore} alt="" className='h-auto w-[160px] hover:scale-90 hover:opacity-80 transition-all'/>
                    </div>
                </div>
