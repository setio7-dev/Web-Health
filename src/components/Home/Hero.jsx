  ...
  return (
    <div className='pt-[25%] lg:px-[75px] lg:pt-[9%] flex justify-around items-center lg:flex-row flex-col-reverse relative' data-aos="fade-up" data-aos-duration="800">
        <div className='flex flex-col lg:space-y-6 space-y-2 lg:items-start items-center'>
            ...
            <p className='lg:w-[550px] w-full lg:text-left text-center lg:px-0 px-[7px] lg:text-[17px] text-[15px] lg:pb-[50px] pb-[40px] font-poppins1'>Lorem ipsum dolor sit amet consectetur. Convallis est urna adipiscing fringilla nulla diam lorem non mauris. Ultrices aliquet at quam. </p>
